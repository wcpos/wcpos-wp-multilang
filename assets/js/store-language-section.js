(function () {
  function registerLanguageSection() {
    ...
    var config = window.wcposWPMultilangStoreEdit || {};
    ...
    var noLanguages = strings.noLanguages || 'No WP Multilang languages found.';

    if (window.wcpos.storeEdit.getSections && window.wcpos.storeEdit.getSections().has('wcpos-wp-multilang-language')) {
      return;
    }
    ...
    window.wcpos.storeEdit.registerSection('wcpos-wp-multilang-language', {
